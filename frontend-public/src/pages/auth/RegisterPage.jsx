import {RegisterForm, OAuthButton} from "../../features/auth/index.js";
        ...
        <div className="min-h-screen flex items-center justify-center"
            ...
            <div
                ...
                <div className={'flex items-center justify-between gap-4 flex-wrap'}>
                    ...
                    <HashLink className={'text-[length:var(--s)] text-[var(--link-color)] hover:underline'} to={'/login'}>Login</HashLink>
                </div>
            </div>
        </div>
    )
