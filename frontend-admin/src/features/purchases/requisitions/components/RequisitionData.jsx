...
export const RequisitionData = () => {
    ...
    const {get, show, loading, detail, setDetail, filters, setFilters} = useRequisition()
    const rows = useRequisitionStore(s => s.data)
    ...
    return <>
        <div className={'flex items-center justify-between gap-4 flex-wrap'}>
            ...
            <div className={'flex items-center justify-between gap-4 w-max flex-wrap'}>
                <Export exportPdfUrl={'/purchase/requisition/export/pdf'}
                        exportExcelUrl={'/purchase/requisition/export/excel'}/>
                    ...
                    <div
                        ...
                        <table className="w-full whitespace-nowrap border-separate border-spacing-0">
                            ...
                            <tr className="[&_th]:bg-[var(--sidebar-color)] [&_th]:border-y [&_th]:border-y-[var(--border-color)] [&_th]:px-4 [&_th]:vertical-middle">
                                ...
                                <th className="h-[63px]">Supplier</th>
