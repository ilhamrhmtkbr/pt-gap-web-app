...
class CartServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->service        = new CartService($this->repositoryMock);
    }
    ...
    {
        $model   = Cart::factory()->make();
        $data    = ['name' => 'Updated'];
        $updated = Cart::factory()->make($data);
