...
class TransactionServiceTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->repositoryMock = Mockery::mock(TransactionRepositoryInterface::class);
        $this->service        = new TransactionService($this->repositoryMock);
    }
    ...
    {
        $model = Transaction::factory()->make(['id' => 1]);
    ...
    {
        $data  = ['id' => '1', 'name' => 'Test'];
        $model = Transaction::factory()->make($data);
    ...
    {
        $model   = Transaction::factory()->make();
        $data    = ['name' => 'Updated'];
        $updated = Transaction::factory()->make($data);
